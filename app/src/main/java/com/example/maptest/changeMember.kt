...
class changeMember : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_change_member,container,false)
        view.underMenu.setOnClickListener { mainActivity?.goBackLo() }
        view.btnBtAddress.setOnClickListener {mainActivity?.findAddress()}
        view.btnChange.setOnClickListener { mainActivity?.changeMemberIT() }
        return view
    }
}